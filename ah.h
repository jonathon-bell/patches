...
#define AH_Lead_8(...)                                                     \
   ...
   Voice(5, 445.0, 3.8, 0.0, 0.0,+10.0,  4.0),__VA_ARGS__)
...
#define AH_Lead_9(...)                                                     \
   ...
   Voice(2,  33.1, 0.0, 0.0, 0.0,+10.0, 10.0),                             \
   Voice(3, 300.0, 5.0, 0.0, 0.0,-10.0,  4.5),                             \
...
#define AH_Stereo(...)                                                     \
   ...
   Delay[11111111] ("AH Stereo   ",ELVL:=10.0,DLVL:=8.0,                   \
                                                                           \
   Voice(1,   5.3, 0.0, 0.0, 0.0,-10.0,  7.0),                             \
   Voice(2,   5.5, 0.0, 0.0, 0.0,+10.0,  9.7), PHS2:=Reverse,              \
